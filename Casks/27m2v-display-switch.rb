cask "27m2v-display-switch" do
  ...
  url "https://github.com/nyushi/27m2v-display-switch/releases/download/v#{version}/27M2V-Display-Switch-v#{version}-macOS-arm64.zip"
  name "27M2V Display Switch"
  desc "Menu bar app for enabling and disabling an INNOCN 27M2V display"
  homepage "https://github.com/nyushi/27m2v-display-switch"
